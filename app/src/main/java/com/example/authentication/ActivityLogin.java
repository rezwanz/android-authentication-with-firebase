...
public class ActivityLogin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loginEmailId = findViewById(R.id.loginpaswd);
        ...
        authStateListener = (FirebaseAuth.AuthStateListener);
                ...
                } signup.setOnClickListener(View::clearViewTranslationCallback);{
                    Intent I = new Intent(ActivityLogin.this, MainActivity.class);
                    startActivity(I);
        }
        btnLogIn.setOnClickListener(View::clearViewTranslationCallback);{
            ...
            if (userEmail.isEmpty()){
                ...
                firebaseAuth.signInWithEmailAndPassword(userEmail, userpaswd).addOnCompleteListener(ActivityLogin.this,(task ->)); {
